...
int main() {
    ...
    scanf("%i",&A); // Lendo o Valor digitado e atribuindo à variável A
    scanf("%i",&B); // Lendo o Valor digitado e atribuindo à variável B
 
    int X = A + B;  // Declarando a uma variável X e atribuindo à ela o valor da Soma de A + B
    printf("X = %i\n", X); // Imprimindo na tela o valor da variável X
    return 0;
}